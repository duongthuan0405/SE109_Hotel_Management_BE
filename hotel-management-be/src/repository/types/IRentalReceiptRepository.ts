...
export interface IRentalReceiptRepository {
  create(data: Omit<RentalSlip, "id" | "createdAt" | "updatedAt" | "booking" | "room" | "checkInStaff" | "code"> & { code?: string | undefined }): Promise<RentalSlip>;
  ...
  findByBookingId(bookingId: string, include?: RentalReceiptInclude): Promise<RentalSlip[]>;
