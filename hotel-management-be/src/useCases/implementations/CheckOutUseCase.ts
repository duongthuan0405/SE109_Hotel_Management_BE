...
import { rentalReceiptRepository, roomRepository, bookingRepository, unitOfWork } from "../../repository/index.js";
      ...
      if (updated.bookingId) {
        ...
        if (!stillInRoom) {
          ...
          if (booking && booking.status !== "CheckedOut") {
            ...
            // Ghi lịch sử tự động
            // Lưu ý: createBookingHistoryUseCase cũng sẽ chạy trong transaction này ngầm định
